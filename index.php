                    ...
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                          <div class=" dropdown mr-4">
                              ...
                              <a href="admin/ajax.php?action=logout2" class="nav-link js-scroll-trigger"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Logout <i class="fa fa-angle-down"></i></a>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.allumnitracking system.com/" target="_blank">allumni tracking system</a></div></div>
        </footer>
